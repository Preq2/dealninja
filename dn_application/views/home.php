  <body>
    <nav id="topNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#first"><i class="icon_logo"><img src="<?=base_url() ?>images/icon_logo.png" /></i> DealNinja</a>
            </div>
            <div class="navbar-collapse collapse" id="bs-navbar">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" href="#three">Plans</a>
                    </li>
                    <!--li>
    ...
    <header id="first">
        <div class="header-content">
            <div class="inner">
            <div style=""><img src="<?=base_url() ?>images/logo_dn_hp.png" /></div>
                
                <h4>Right Car, Best Bank, 10 seconds.</h4>
                <hr>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 text-center">
                    <h2 class="margin-top-0 text-primary">Powerful Dealer Tools from DealNinja</h2>
                    <br>
                    <p class="text-faded">
                        Deal Ninjas is a simple, yet powerful tool that matches your customer with the right bank, on the right car. Stop working your customer and instead put your banks and your inventory to work for you. It enables your employees to desk deals in seconds without ever having to look at rate sheet. 
                    </p>
    ...
    <section class="container-fluid" id="two">
        <div class="row">
            <div class="col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
                <h2 class="text-center text-primary">Features of What DealNinja Offers</h2>
                <hr>
                <div class="media wow fadeInRight">
                    <h3>Powerful</h3>
                    <div class="media-body media-middle">
                        <p>Deal Ninja tracks all lenders rates, terms, and advances (both front and back), to make sure your working your banks to your advantage. From the nationwide lenders, to the captives,  to your local credit union, we track them all.</p>
                    </div>
                ...
                <div class="media wow fadeIn">
                    ...
                    <div class="media-body media-middle">
                        <p>We download your inventory daily, New cars from your DMS, used cars from the appraisal software you use.</p>
                    </div>
                </div>
                <hr>
                <div class="media wow fadeInRight">
                    <h3>No set up fees, no contracts.</h3>
                    <div class="media-body media-middle">
                        <p>Pay by the month, and cancel at anytime with no notice.<p>
                    </div>
                    <div class="media-right">
                ...
                <hr>
                <div class="media wow fadeIn">
                    <h3>Collect Accurate information</h3>
                    <div class="media-left">
                        <i class="icon-lg ion-ios-heart-outline"></i>
                    </div>
                    <div class="media-body media-middle">
                        <p>Income calculators are included to make sure your people are collecting accurate information. If your customer has a paystub ending 6/12/2015 and his YTD is 18,845, what is his monthly income? Verifyable income is 3483 per month. No more calculating by hand how many weeks are in the YTD pay, the calculator does it for you.  </p>
                    </div>
                </div>
                <hr>
                <div class="media wow fadeInRight">
                    <h3>Productivity</h3>
                    <div class="media-body media-middle">
                    <div> Spend your time wisely. Would you rather have your sales managers chained to their desk flipping thru rate sheets or would you rather have them getting up and closing customer?<p>
                    </div>
                    <div class="media-right">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="margin-top-0 text-primary">Subscription Plan</h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 text-center">
                    <div class="feature">
                        ...
                        <h3>License</h3>
                        <p class="text-muted">149 per month.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 text-center">
                    <div class="feature">
                    <img src="<?=base_url() ?>images/bank_icon_lg.png" />
                        <!--i class="icon-lg ion-social-sass wow fadeInUp" data-wow-delay=".2s"></i-->
                        <h3>Bank Tracking</h3>
                        <p class="text-muted">$25 per bank that you want us to maintain rates and terms for</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 text-center">
                    <div class="feature">
                        ...
                        <h3>Thats it!</h3>
                        <p class="text-muted">Month to month agreement, No up fronts, no paymnet due now. Pay at the end of the month only if you want to continue using the software. </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <aside class="bg-dark">
        <div class="container text-center">
            <div class="call-to-action">
                ...
                <a href="#" target="ext" class="btn btn-default btn-lg wow flipInX">Open an Account Today</a>
            </div>
            <br>
            <hr/>
            <br>
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1">
                    <div class="row">
                        ...
                        <img src="<?=base_url() ?>images/logo_dn_hp_wh.png" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <hr class="primary">
                    <p>We want to hear from you. Fill out the form below and we'll get back to you as soon as possible.</p>
                </div>
