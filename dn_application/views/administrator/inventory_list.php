    ...
    <div id="rightside">
        ...
        <div class="contentcontainer">
            ...
            <ul class="pagination" style="margin-top:10px;">
            	...
            	<li class="page"><a href="index.php?/administrator/inventory_add/<?=$did ?>" title=""><span style="font-size: 16px; text-shadow: 1px 1px 1px #666;">Add New / Import - Export</span></a></li>
            </ul>
            </div>
...
?>
                    	...
                    	<tr<?=$bg  ?>>
                            ...
                            <td>
                                ...
                                <a href="index.php?/administrator/inventory_del/<?= $inventory_item['dealer_id'] ?>/<?= $inventory_item['inventory_id'] ?>" title=""><img src="./images/icons/icon_delete.png" alt="Delete" onclick="return confirm('Are you sure you wish to delete this inventory?');" /></a>
                            </td>
