            ...
            <div class="contentbox">
            	<div class="sm_txt">* Required</div>
            		...
            		<p>
                        ...
                        <input type="text" id="bank_name" name="bank_name" class="inputbox" /> 
                    </p>

            		<p>
                        <label for="bank_address1"><strong>Address 1:</strong></label>
                        <input type="text" id="bank_address1" name="bank_address1" class="inputbox" /> 
                    </p>
                    
            		<p>
                        <label for="bank_address2"><strong>Address 2:</strong></label>
                        <input type="text" id="bank_address2" name="bank_address2" class="inputbox" /> 
                        <!--br />
            		...
            		<p>
                        ...
                        <input type="text" id="bank_city" name="bank_city" class="inputbox" /> 
                    </p>
            		...
            		<p>
                        ...
                        <input type="text" id="bank_zip" name="bank_zip" class="inputbox inputboxsm" /> 
                    </p>
                    
            		<p>
                        <label for="bank_phone"><strong>Phone:</strong></label>
                        <input type="text" id="bank_phone" name="bank_phone" class="inputbox inputboxsm" /> 
                        
                    </p> 
                    
            		<p>
                        <label for="bank_email"><strong>Email:</strong></label>
                        <input type="text" id="bank_email" name="bank_email" class="inputbox" /> 
                        
                    </p> 
                    
            		<p>
                        <label for="bank_url"><strong>Website:</strong></label>
                        <input type="text" id="bank_url" name="bank_url" class="inputbox" /> 
                        
                    </p> 

					<input id="banks_submit" name="banks_submit" type="button" value="  Add  " class="btn_fi" onClick="val_bank('add');">
